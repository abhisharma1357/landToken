...
contract LandOrc is Initializable, ERC20Upgradeable, ERC20BurnableUpgradeable, PausableUpgradeable, AccessControlEnumerableUpgradeable, UUPSUpgradeable {
    ...
    function setLandNFTAddress(address _address) public onlyRole(DEFAULT_ADMIN_ROLE) returns (bool){
    ...
    function setRewardVaultAddress(address _address) public onlyRole(DEFAULT_ADMIN_ROLE) returns (bool){
    ...
    function setExchangeAddress(address _address) public onlyRole(DEFAULT_ADMIN_ROLE) returns (bool){
    ...
    function setRewardPercentage(uint _rewardPercentage) public onlyRole(DEFAULT_ADMIN_ROLE) returns (bool){
    ...
    function addBlackList (address _address) public onlyRole(DEFAULT_ADMIN_ROLE) {
        isBlackListed[_address] = true;
        emit AddedBlackList(_address);
    }

    /// @dev remove blacklist address 
    function removeBlackList (address _address) public onlyRole(DEFAULT_ADMIN_ROLE) {
    ...
    function mintNFTReward( uint256 _amount) public whenNotPaused onlyNFTContract {
